...
function AppWrapper(props) {
  ...
  (0, _react.useEffect)(function () {
    var newAppSettings = _objectSpread(_objectSpread({}, appSettings), props.settings);

    dispatch((0, _actions.changeAppSettings)(newAppSettings));
  }, [props.settings, dispatch, _actions.changeAppSettings]); // eslint-disable-line react-hooks/exhaustive-deps
